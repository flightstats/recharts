...
@AnimationDecorator
@pureRender
class BruashedBarChart extends Component {

  static displayName = 'BruashedBarChart';
...
export default generateCategoricalChart(BruashedBarChart, Bar);
export { BruashedBarChart };
