...
var computeData = function computeData(_ref2) {
  ...
  var _getNodesTree = getNodesTree(data, width, nodeWidth),
      ...
      maxDepth = _getNodesTree.maxDepth;
  ...
  _createClass(Sankey, [{
    ...
    value: function renderLinks(links, nodes) {
      var _props3 = this.props,
          linkCurvature = _props3.linkCurvature,
          linkContent = _props3.link,
    ...
    value: function render() {
      ...
      var _props5 = this.props,
          data = _props5.data,
          iterations = _props5.iterations,
          nodeWidth = _props5.nodeWidth,
          nodePadding = _props5.nodePadding,
          width = _props5.width,
          ...
          others = _objectWithoutProperties(_props5, ['data', 'iterations', 'nodeWidth', 'nodePadding', 'width', 'height', 'className', 'style', 'children', 'margin']);
