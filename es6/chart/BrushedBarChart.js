...
exports.BruashedBarChart = undefined;
...
var _SnappedBrush = require('../cartesian/SnappedBrush');

var _SnappedBrush2 = _interopRequireDefault(_SnappedBrush);
...
var BruashedBarChart = (0, _AnimationDecorator2.default)(_class = (0, _PureRender2.default)(_class = (_temp = _class2 = function (_Component) {
  _inherits(BruashedBarChart, _Component);

  function BruashedBarChart() {
    _classCallCheck(this, BruashedBarChart);

    return _possibleConstructorReturn(this, (BruashedBarChart.__proto__ || Object.getPrototypeOf(BruashedBarChart)).apply(this, arguments));
  }

  _createClass(BruashedBarChart, [{
    key: 'getComposedData',
    ...
    value: function getBarPosition(bandSize, sizeList) {
      var _props2 = this.props,
          barGap = _props2.barGap,
          barCategoryGap = _props2.barCategoryGap;
      ...
      if (sizeList[0].barSize === +sizeList[0].barSize) {
        ...
        var size = (bandSize - 2 * _offset - (len - 1) * barGap) / len >> 0;

        result = sizeList.reduce(function (res, entry, i) {
          var newRes = _extends({}, res, _defineProperty({}, entry.dataKey, {
            offset: _offset + (size + barGap) * i,
            size: size
          }));
      ...
      for (var i = 0, len = numericAxisIds.length; i < len; i++) {
        ...
        for (var j = 0, sLen = stackIds.length; j < sLen; j++) {
          var _sgs$stackIds$j = sgs[stackIds[j]],
              ...
              numericAxisId = _sgs$stackIds$j.numericAxisId,
    ...
    value: function renderCursor(xAxisMap, yAxisMap, offset) {
      var _props4 = this.props,
          ...
          isTooltipActive = _props4.isTooltipActive,
          layout = _props4.layout,
          activeTooltipIndex = _props4.activeTooltipIndex;
    ...
    value: function render() {
      var _props5 = this.props,
          isComposed = _props5.isComposed,
          graphicalItems = _props5.graphicalItems,
          xAxisMap = _props5.xAxisMap,
          yAxisMap = _props5.yAxisMap,
          offset = _props5.offset,
          stackGroups = _props5.stackGroups,
          data = _props5.data,
          brushProps = _props5.brushProps;


      var newBrushProps = Object.assign({
        x: offset.left,
        y: offset.top,
        width: offset.width,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_SnappedBrush2.default, newBrushProps)
      );
    }
  }]);

  return BruashedBarChart;
}(_react.Component), _class2.displayName = 'BruashedBarChart', _class2.propTypes = {
  ...
  brushProps: _propTypes2.default.object,
...
exports.default = (0, _generateCategoricalChart2.default)(BruashedBarChart, _Bar2.default);
exports.BruashedBarChart = BruashedBarChart;