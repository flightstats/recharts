  ...
  var CategoricalChartWrapper = (_temp = _class = function (_Component) {
    ...
    function CategoricalChartWrapper(props) {
      ...
      _this.handleBrushChange = function (_ref) {
        ...
        if (_this.props.onBrushChange) {
          _this.props.onBrushChange(startIndex, endIndex);
        }
      };
      ...
      */
      ...
      value: function getTooltipContent(items) {
        var _state3 = this.state,
            activeTooltipIndex = _state3.activeTooltipIndex,
      ...
      value: function renderTooltip(xAxisMap, yAxisMap, tooltipItem, items, offset) {
        ...
        var _state4 = this.state,
            ...
            activeTooltipIndex = _state4.activeTooltipIndex,
            chartX = _state4.chartX,
            chartY = _state4.chartY;
      ...
      value: function render() {
        ...
        var _props10 = this.props,
            ...
            layout = _props10.layout,
            className = _props10.className,
            width = _props10.width,
            height = _props10.height,
            stackOffset = _props10.stackOffset,
            style = _props10.style,
            others = _objectWithoutProperties(_props10, ['children', 'layout', 'className', 'width', 'height', 'stackOffset', 'style']);
