...
var Brush = (0, _PureRender2.default)(_class = (_temp = _class2 = function (_Component) {
  ...
  _createClass(Brush, [{
    ...
    value: function handleSlideMove(e) {
      ...
      var eventNearest = this.nearestSnapValue(e.pageX);
    ...
    value: function handleTravellerMove(e) {
      ...
      var newValue = this.nearestSnapValue(e.pageX);
      ...
      if (otherValue !== newValue) {
        (function () {
          ...
          _this3.setState((_this3$setState = {}, _defineProperty(_this3$setState, movingTravellerId, newValue), _defineProperty(_this3$setState, 'brushMoveStartX', e.pageX), _this3$setState), function () {
            if (onChange) {
              onChange(newIndex);
            }
          });
