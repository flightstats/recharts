...
var RadarChart = (0, _AnimationDecorator2.default)(_class = (0, _PureRender2.default)(_class = (_temp2 = _class2 = function (_Component) {
  ...
  _createClass(RadarChart, [{
    ...
    value: function render() {
      ...
      var _props7 = this.props,
          ...
          style = _props7.style,
          others = _objectWithoutProperties(_props7, ['className', 'data', 'width', 'height', 'margin', 'children', 'style']);
  ...
  return RadarChart;
}(_react.Component), _class2.displayName = 'RadarChart', _class2.defaultProps = {
  width: 0,
  height: 0,
  cx: '50%',
  cy: '50%',
