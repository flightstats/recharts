  ...
  _createClass(RadialBarChart, [{
    ...
    value: function render() {
      ...
      var _props4 = this.props,
          ...
          others = _objectWithoutProperties(_props4, ['style', 'children', 'className', 'width', 'height', 'margin']);
...
}(_react.Component), _class2.displayName = 'RadialBarChart', _class2.defaultProps = {
  cx: '50%',
  cy: '50%',
  innerRadius: '30%',
  outerRadius: '90%',
